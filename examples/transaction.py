...
tokens = cl.create_transaction(customer_uid="this_is_a_customer_uid", template_key=os.environ["BERBIX_DEMO_TEMPLATE_KEY"])
...
completed_transaction = cl.override_transaction(tokens, response_payload="us-dl", flags=["id_under_18", "id_under_21"])

pprint.pprint(completed_transaction)

updated_transaction = cl.update_transaction(tokens, action="accept", note="making an exception for this person")
